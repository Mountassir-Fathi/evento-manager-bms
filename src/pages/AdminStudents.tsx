  ...
  return <Layout>
      <div className="space-y-8 fade-in">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-primary to-blue-700 bg-clip-text text-transparent text-center">
        ...
        <StudentDialog open={dialogOpen} onOpenChange={setDialogOpen} onSubmit={handleAddOrUpdate} student={editingStudent} />
      </div>
    </Layout>;
};
